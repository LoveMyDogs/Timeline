...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Our-Project">Our Project<a class="anchor-link" href="#Our-Project"> </a></h2><p>Errors that may arise in our project are the quiz not working, things not correctly appending to dictionaries, etc. Some test cases that could be used is looking at individual elements to see if they would work, adding harmless print functions, or adding test functions that are very similar to the original to see what works. 
We will document bugs and what we do.</p>
